...
public class AdminView_ViewTotalSpendings {
	private Button backButton;
	Administrator opener;
    

    public AdminView_ViewTotalSpendings() {
    ...
    public AdminView_ViewTotalSpendings(Administrator opener) {
        this.backButton = new Button("Back");
        this.backButton.setStyle("-fx-background-color: #dd5f5f; -fx-text-fill: white; -fx-font-size: 25px; -fx-padding: 10px 20px;");
        this.backButton.setPrefWidth(270);
        this.opener=opener;
    ...
    public void display(Stage primaryStage) {
        ...
        Label spendingsLabel = new Label("Spendings: " +admin.getTotalSpendings()+"$" );
        spendingsLabel.setStyle("-fx-text-fill: white; -fx-font-size: 50px; -fx-font-weight: bold;");
        ...
        buttonGrid.getChildren().add(spendingsLabel);
        ...
        primaryStage.setTitle("ElectronX - Administrator View - Total spendings");
