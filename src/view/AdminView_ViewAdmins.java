...
public class AdminView_ViewAdmins {
    ...
    public AdminView_ViewAdmins(Administrator opener) {
        this.backButton = new Button("Back");
        this.backButton.setStyle("-fx-background-color: #dd5f5f; -fx-text-fill: white; -fx-font-size: 25px; -fx-padding: 10px 20px;");
        this.backButton.setPrefWidth(270);
    ...
    public void display(Stage primaryStage) {
        ...
        primaryStage.setTitle("ElectronX - Administrator View - view Admins");
    ...
    private void populateAdminComboBox() {
    	Administrator admin = new Administrator();
        ArrayList<Administrator> admins = admin.viewAdmins();  // Get the list of employees
        ...
        for (Administrator adm : admins) {
            cashierNames.add(adm.getname());  // Use `getName` or another method to get the employee name
        }
        ...
        Platform.runLater(() -> {
            ...
            cashierComboBox.setPromptText("View Admins");
        });
    }
