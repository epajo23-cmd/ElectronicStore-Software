...
public class AdminView_ViewCashiers {
    ...
    public AdminView_ViewCashiers(Administrator opener) {
        this.backButton = new Button("Back");
        this.backButton.setStyle("-fx-background-color: #dd5f5f; -fx-text-fill: white; -fx-font-size: 25px; -fx-padding: 10px 20px;");
        this.backButton.setPrefWidth(270);
    ...
    public void display(Stage primaryStage) {
        ...
        primaryStage.setTitle("ElectronX - Administrator View - view Cashiers");
    ...
    private void populateCashierComboBox() {
    	Administrator admin = new Administrator();
        ArrayList<Cashier> cashiers = admin.viewCashiers();  // Get the list of employees
        ...
        for (Cashier cashier : cashiers) {
            cashierNames.add(cashier.getname() + " - " + cashier.getSector().getName());  // Use `getName` or another method to get the employee name
        }
