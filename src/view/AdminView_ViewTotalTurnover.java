...
public class AdminView_ViewTotalTurnover {
	private Button backButton;
	@SuppressWarnings("unused")
	Administrator opener;
    

    public AdminView_ViewTotalTurnover() {
    ...
    public AdminView_ViewTotalTurnover(Administrator opener) {
        this.backButton = new Button("Back");
        this.backButton.setStyle("-fx-background-color: #dd5f5f; -fx-text-fill: white; -fx-font-size: 25px; -fx-padding: 10px 20px;");
        this.backButton.setPrefWidth(270);
        this.opener=opener;
    ...
    public void display(Stage primaryStage) {
        ...
        Label turnoverLabel = new Label("Turnover: "+ admin.getTotalTurnover() +"$");
        turnoverLabel.setStyle("-fx-text-fill: white; -fx-font-size: 50px; -fx-font-weight: bold;");
        ...
        primaryStage.setTitle("ElectronX - Administrator View - Total turnover");
