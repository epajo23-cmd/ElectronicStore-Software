...
public class ManagerView_ViewManagedCashiers {
    private Button backButton;
    private ComboBox<String> cashierComboBox;  // ComboBox for sectors
    Manager opener;

    public ManagerView_ViewManagedCashiers() {
        ...
        this.cashierComboBox.setPromptText("View Cashiers");
        this.cashierComboBox.setStyle("-fx-font-size: 18px; -fx-padding: 10px;");
        this.cashierComboBox.setPrefWidth(270);  // Set the same width as the back button
        
        this.opener = null;
    }

    public ManagerView_ViewManagedCashiers(Manager opener) {
        this();
        this.opener = opener;
    }
    ...
    public void display(Stage primaryStage) {
        ...
        primaryStage.setTitle("ElectronX - Manager View - Managed Cashiers");
    ...
    private void populateSectorComboBox() {
        ArrayList<Cashier> cashiers = opener.viewManagedCashiers();  // Get the list of sectors
        ArrayList<String> cashierNames = new ArrayList<>();
        
        // Add sector names to list
        for (Cashier cashier : cashiers) {
            cashierNames.add(cashier.getname() +" - "+ cashier.getSector().getName()); 
        }
        ...
        Platform.runLater(() -> {
            ...
            cashierComboBox.setPromptText("View Cashiers");
        });
    }
}
